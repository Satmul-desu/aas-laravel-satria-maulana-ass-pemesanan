            ...
            <div class="card shadow-lg border-0 rounded-lg">
                <div class="card-header bg-gradient-warning text-white py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="mb-1"><i class="fas fa-edit me-2"></i>Edit Pelanggan</h3>
                            <p class="mb-0 opacity-75">Perbarui informasi pelanggan</p>
                        </div>
                ...
                <div class="card-body p-5">
                    <form action="{{ route('pelanggans.update', $pelanggan) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control @error('alamat') is-invalid @enderror"
                                                              ...
                                                              placeholder="Masukkan alamat lengkap pelanggan" required>{{ old('alamat', $pelanggan->alamat) }}</textarea>
                                                    <label for="alamat">
                                ...
                                <div class="card border-success shadow-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-10">
                                                <h5 id="preview-nama" class="mb-1">{{ $pelanggan->nama }}</h5>
                                                <p id="preview-email" class="text-muted mb-1">Email: <span class="text-primary">{{ $pelanggan->email }}</span></p>
                                                <p id="preview-telepon" class="text-muted mb-1">Telepon: <span class="text-primary">{{ $pelanggan->telepon }}</span></p>
                                                <p id="preview-alamat" class="text-muted mb-1">{{ $pelanggan->alamat }}</p>
                                                <div class="d-flex gap-3">
                                                    <small class="text-muted">
                                                        <i class="fas fa-hashtag me-1"></i><span id="preview-kode">{{ $pelanggan->kode_pelanggan }}</span>
                                                    </small>
                                                </div>
                                            </div>
                                        </div>

                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="user">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="password" type="password" class="form-control form-control-user @error('password') is-invalid @enderror"
                                   ...
                                   placeholder="Masukkan password baru" style="border-radius: 10px; padding: 12px;">
                            @error('password')
                                <div class="invalid-feedback d-block">
                                    <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="password-confirm" type="password" class="form-control form-control-user @error('password_confirmation') is-invalid @enderror"
                                   name="password_confirmation" required autocomplete="new-password"
                                   placeholder="Konfirmasi password baru" style="border-radius: 10px; padding: 12px;">

                ...
                <div class="card-header bg-gradient-success text-white py-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="mb-0 opacity-75">Buat pemesanan alat baru dengan mudah</p>
                        </div>
...
$(document).ready(function() {
    ...
    $(document).on('change', '.alat-select', function() {
        ...
        // Set max jumlah based on stok
        const jumlahInput = $(this).closest('.alat-item').find('.jumlah-input');
    ...
    // Add first alat row on page load
    addAlatRow();
});
</script>
@endsection
